...
.
```markdown
Opus UI was initially developed by [{"cpt": "Intenda", "attributes": { "target": "_blank" } }](https://intenda.tech/) as a low-code application development module for our flagship platform, [{"cpt": "Fraxses", "attributes": { "target": "_blank" } }](https://intenda.tech/fraxses-overview/). While it is still part of the Fraxses platform stack, we have made the decision to [{"cpt": "open source Opus UI", "attributes": { "target": "_blank" } }](blog/post?postId=0) as a library. 
...
At Intenda, we see data inside out and we firmly believe that optimal data management leads to vastly improved business performance. Drawing on over 20 years of software development experience, we build solutions that solve today’s data challenges, supporting our customers digital transformation journey and enabling them to become data-driven.
